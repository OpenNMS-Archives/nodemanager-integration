...
public class Filter {
    ...
    public void setCategoryMatcher(String categoryMatcherRegexp) {
        if (categoryMatcherRegexp == null) {
            m_categoryMatcher = null;
        } else {
    ...
    public void setEventNameMatcher(String eventNameMatcherRegexp) {
        if (eventNameMatcherRegexp == null) {
            m_eventNameMatcher = null;
        } else {
    ...
    public void setSeverityMatcher(String severityMatcherRegexp) {
        if (severityMatcherRegexp == null) {
            m_severityMatcher = null;
        } else {
    ...
    public void setAddressMatchSpec(String addressMatchSpec) {
        if (addressMatchSpec == null) {
            m_addressMatchSpec = null;
        } else {
    ...
    public String toString() {
        StringBuffer buf = new StringBuffer("[ "+m_action+": ");
